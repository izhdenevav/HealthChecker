...
#             indices = [i for i, (_, hr) in enumerate(dataset) if hr_min <= hr < hr_max]
...
def main():
    ...
    for epoch in range(num_epochs):
        ...
        mae, rmse, pearson_r = compute_metrics(pred, ppg_signal)
        print(f"Val MAE: {mae:.4f}, RMSE: {rmse:.4f}, Pearson r: {pearson_r:.4f}")
